...
public class HelloWorldService {
  ...
  public Response helloPerson() {
    ...
    // create an entry in the table t_person
    Person person = personService.findByName("wolfgang");
    return Response.status(200).entity("Rest Enpoint , Date 10.05.2020 - Hello " + ( person!=null ?person.getName(): "-" ) ).build();
  }
